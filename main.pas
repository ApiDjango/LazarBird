...
type
  ...
  public
    // Array of database connection details as stored in LazarBird.reg file
...
uses ViewView, ViewTrigger, ViewSProc, ViewGen, NewTable, NewGen,
...
begin
  ...
  StatusBar1.Panels[0].Text:= 'LazaBird for ' + Target + '-' + Arch;
end;
...
begin
  if IsLinux then
  begin
    ConfigDir:= GetEnvironmentVariable('HOME') + DirectorySeparator + '.LazarBird' + DirectorySeparator;
    ...
    case Node.Level of
      ...
      begin
        ...
        case ParentText of
          ...
          else ShowMessage('Error LazarBird code tVMainDblClick level 3. Please correct.');
        end;
      end;
      4: // Table fields (Edit)
      begin
...
begin
  try
    tvMain.Items.Clear;
    ReleaseRegisteredDatabases;
    FileName:= getConfigurationDirectory + 'LazarBird.reg';
